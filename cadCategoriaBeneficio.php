...
if ($_REQUEST['action'] == 'insert') {
    ...
    $action = "dbCadCategoriaBeneficio.php?action=insert";

    $id = "";
    $categoria = "";
} elseif ($_REQUEST['action'] == 'edit') {

    $action = "dbCadCategoriaBeneficio.php?action=edit";

    $id = anti_injection($_REQUEST['id']);

    $sql = "select * from categoriaben where id = $id";
    $rs = $conn->query($sql);
                                                        ...
                                                        <form action="<?= $action ?>" method="POST">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <a href="#" class="btn btn-danger btn-sm" onclick="window.location='listaCategoriasBeneficios.php'">Cancelar</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
