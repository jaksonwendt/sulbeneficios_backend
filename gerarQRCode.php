...
?>
    ...
    <body>
        <div class="container">
            <img src="<?= $return['logo'] ?>" alt="QR Code">
            <h1><?= $return['nome'] ?></h1>
            <p>Aponte a câmera do seu celular para o QR code e aguarde até que o código seja reconhecido. Em seguida, você poderá informar o seu desconto!</p>
