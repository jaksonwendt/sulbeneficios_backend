...
if ($_REQUEST['action'] == 'edit') {
    ...
    $action = "dbCadUtilizacao.php?action=edit";

    $id = anti_injection($_REQUEST['id']);

    $sql = "select * from utilizacao where id = $id";
    $rs = $conn->query($sql);
    ...
    if ($rs->rowCount() > 0) {
        ...
        $comercio = $conn->query("select nome from comercio where id = $comercio")->fetchColumn();
    } else {
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#">Uso de benefício</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <form action="<?= $action ?>" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <input type="text" class="form-control" name="comercio" id="comercio" value="<?= $comercio ?>" disabled>
                                                                </div>
                                                                <div class="col-sm-2">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <a href="#" class="btn btn-danger btn-sm" onclick="window.location='listaUtilizacao.php'">Cancelar</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
