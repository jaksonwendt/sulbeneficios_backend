                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <a class="btn btn-success btn-sm" href="cadCategoriaBeneficio.php?action=insert"><i class="fa fa-plus"></i> Adicionar</a>
                                                        <br>
                                                        <br>
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                            <tr>
                                                                                <td><?= $ln['categoria'] ?></td>
                                                                                <td>
                                                                                    <a class="btn btn-info btn-sm" href="cadCategoriaBeneficio.php?action=edit&id=<?= $ln['id'] ?>"><i class="fa fa-edit"></i> Editar</a>
    ...
    <script>
        function excluir(item) {
            if (confirm('Tem certeza que deseja excluir?')) {
                window.location = "dbCadCategoriaBeneficio.php?action=delete&id=" + item;
            }
        }
    </script>
</body>
