...
if (!empty($_REQUEST['email'])) {
    ...
    $sql = "select * from usuarios where login = :login and senha = :senha and ativo = 'S'";
    $rs = $conn->prepare($sql);
    $rs->bindParam('login', $login);
    $rs->bindParam('senha', md5($password));
    $rs->execute();
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <span class="form-bar" style="color: red">
                                        <br>
                                        <?php if (!empty($error)) {
                                            echo $error;
                                        }  ?>
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <input type="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" value="Entrar">
                                    </div>
                                </div>
                            </div>
                        </div>
