...
if ($_REQUEST['action'] == 'insert') {
    ...
    $action = "dbCadCategoria.php?action=insert";
    ...
    $action = "dbCadCategoria.php?action=edit";
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#">Cadastro de categorias</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <form action="<?= $action ?>" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-6">
                                                                    ...
                                                                    <input type="text" class="form-control" name="categoria" id="categoria" value="<?= $categoria ?>" required>
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <label for="icone">Ícone: <sup>135px x 135px</sup></label>
                                                                    <input type="file" name="icone" id="icone" class="form-control">
                                                                </div>
                                                                <div class="col-sm-3">
                                                                    <?php
                                                                    if ($_REQUEST['action'] == 'edit' && !empty($icone)) {
                                                                        echo "<label for='#'>Clique no ícone para remover</label>";
                                                                        echo "<br>";
                                                                        echo "<img src='$icone' class='thumb-logo' onClick='deleteLogo($id)' />";
                                                                    }
                                                                    ?>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <a href="#" class="btn btn-danger btn-sm" onclick="window.location='listaCategoria.php'">Cancelar</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
    ...
    <script>
        function deleteLogo(item) {
            if (confirm('Tem certeza que deseja remover a logo?')) {
                window.location = "dbCadCategoria.php?action=deletelogo&id=" + item;
            }
        }
    </script>
</body>
