                                                    ...
                                                    <div class="card-block">
                                                        <form action="#" method="GET" id="frmFiltro">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <label for="fdatainicio">Início:</label>
                                                                    <input type="date" class="form-control" name="fdatainicio" id="fdatainicio" value="<?= date("Y-m-d") ?>">
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    <label for="fdatafinal">Final:</label>
                                                                    <input type="date" class="form-control" name="fdatafinal" id="fdatafinal" value="<?= date("Y-m-d") ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>
                                                                            <tr>
                                                                                ...
                                                                                <td><?= $tipo ?></td>
                                                                                <td>
                                                                                    <a class="btn btn-info btn-sm" href="cadUtilizacao.php?action=edit&id=<?= $ln['id'] ?>"><i class="fa fa-edit"></i> Editar</a>
    ...
    <script>
        function excluir(item) {
            if (confirm('Tem certeza que deseja excluir?')) {
                window.location = "dbCadUtilizacao.php?action=delete&id=" + item;
            }
        }
