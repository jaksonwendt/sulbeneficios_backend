                                            ...
                                            <div class="col-sm-12">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <form action="relSorteio.php" method="GET" id="frmFiltro" target="_blank">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <label for="fdatainicio">Data Cadastro Início:</label>
                                                                    <input type="date" class="form-control" name="fdatainicio" id="fdatainicio">
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    <label for="fdatafinal">Data Cadastro Final:</label>
