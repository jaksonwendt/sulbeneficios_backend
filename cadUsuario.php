...
if ($_REQUEST['action'] == 'insert') {
    ...
    $action = "dbCadUsuario.php?action=insert";
    ...
    $action = "dbCadUsuario.php?action=edit";
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#">Cadastro de usuário</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                        ...
                                                        <form action="<?= $action ?>" method="POST">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-3">
                                                                    ...
                                                                    <input type="email" class="form-control" name="email" id="email" value="<?= $login ?>" required>
                                                                </div>
                                                                <div class="col-sm-3">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <a href="#" class="btn btn-danger btn-sm" onclick="window.location='listaUsuario.php'">Cancelar</a>
                                                                </div>
                                                            </div>
                                                        </form>
                                                    </div>
